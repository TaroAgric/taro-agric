  ...
  return (
    <>
      ...
      <div className=" w-full">
        <div className="w-full bg-gradient-to-r from-[#E8DFCA] to-[#F5EFE6]">
          <div className="max-w-screen-2xl mx-auto flex flex-row items-center justify-between sm:pt-16 pt-12  rounded-b-2xl  sm:mb-10 mb-5">
        ...
        <div className="flex flex-col lg:flex-row items-stretch justify-around gap-5 p-5 max-w-screen-2xl mx-auto sm:mb-20 mb-10">
          <div className="bg-[#1E624D] text-white text-center rounded-md p-7 lg:w-1/4 w-full h-full">
            ...
            <p className="xl:text-xl text-base">
              ...
              farming practices. We lead with cutting-edge solutions for
              superior results.
            </p>
          </div>
          ...
          <div className="bg-[#1E624D] text-white text-center rounded-md p-7 lg:w-1/4 w-full h-full">
            ...
            <div className="bg-white w-full h-0.5 mb-4"></div>
            <p className="xl:text-xl text-base">
              Every bird is raised under the highest standards of health,
              safety, and care. From farm to table, we promise products you can
              trust.
            </p>
          </div>
        </div>
